...
// $query =$conn->prepare("INSERT INTO mst_user(user_id,login,pass,username,address,city,phone,email) VALUES('$uid','$lid','$pass','$name','$address','$city','$phone','$email')");
// var_dump($query);die();

// $_SESSION['user_register'] =true;
// $_SESSION['user_submit_data'] = $query;
// $login_id=null;
// if (isset(var)) {
//   # code...
// }
// $_SESSION['lid'];
// var_dump($_SESSION['lid']);die();
...
?>
 <table width="100%" border="0">
   ...
   <tr>
     <td><form name="form1" method="post" action="signupuser.php" onSubmit="return check();" type="submit">
